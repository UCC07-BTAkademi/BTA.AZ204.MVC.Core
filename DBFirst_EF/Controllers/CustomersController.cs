...
namespace DBFirst_EF.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Fax")] Customer customer)
        {
            ...
            {
                _context.Add(customer); // Kayıt SQL tarafına gönderildi.
                await _context.SaveChangesAsync(); // DB üzerinde gelen datalar kalıcı olarak ilgili DB tablosuna Commit ediliyor.
